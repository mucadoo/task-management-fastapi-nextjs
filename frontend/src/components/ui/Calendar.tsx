  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-brand-500 text-white hover:bg-brand-600 focus:bg-brand-500 focus:text-white",
        day_today: "bg-warm-100 dark:bg-white/10 text-warm-900 dark:text-gray-100",
        day_outside: "day-outside text-warm-500 dark:text-gray-400 opacity-50 aria-selected:bg-warm-100/50 dark:aria-selected:bg-white/5 aria-selected:text-warm-500 dark:aria-selected:text-gray-400 aria-selected:opacity-30",
        day_disabled: "text-warm-500 dark:text-gray-400 opacity-50",
        day_range_middle: "aria-selected:bg-warm-100 dark:aria-selected:bg-white/10 aria-selected:text-warm-900 dark:aria-selected:text-gray-100",
